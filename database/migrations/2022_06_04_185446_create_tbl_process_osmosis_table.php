...
class CreateTblProcessOsmosisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tblProcessOsmosis', function (Blueprint $table) {
            $table->id('dblProcessOsmosis');
    ...
    {
        Schema::dropIfExists('tblProcessOsmosis');
    }
}
