...
class CreateSedimentadorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tblProcessSedimentador', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tblProcessSedimentador');
    }
}
